...
Nova.booting(function (Vue, router) {
    Vue.component('customizable-image-card', __webpack_require__(2));
});
    ...
    methods: {
        getData: function getData() {
            ...
            Nova.request().get('/nova-vendor/aozen/customizable-image-card/', {
                ...
                _this.$set(_this, 'redirectUrl', data.redirectUrl);
                _this.$set(_this, 'title', data.title);
                _this.$set(_this, 'imageUrl', data.imageUrl);
                _this.$set(_this, 'textcolor', data.textcolor);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "main-container px-3 py-3", class: _vm.card.isFlex },
        [
          _c(
            "div",
            {
              staticClass:
                "img-container text-center text-3xl text-80 font-light verticallycenter",
              class: _vm.card.imgsize
            },
            [
              _c(
                "a",
                {
                  staticClass: "anchorstyle",
                  attrs: { href: _vm.card.redirectUrl, target: "_blank" }
                },
                [
                  _c("img", {
                    staticStyle: { margin: "5px" },
                    attrs: { src: _vm.card.imageUrl }
                  })
                ]
              )
            ]
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  staticClass: "anchorstyle",
                  style: { color: _vm.card.textcolor },
                  attrs: { href: _vm.card.redirectUrl, target: "_blank" }
                },
                [
                  _vm._v(
